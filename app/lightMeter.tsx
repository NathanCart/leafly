    ...
    if (measuring) {
      const timer = setTimeout(() => {
        ...
        if (reading < 30) {
          ...
          setDescription('This spot receives minimal natural light, suitable for shade-loving plants.');
          setSuitablePlants(['Snake Plant', 'ZZ Plant', 'Pothos', 'Peace Lily']);
        } else if (reading < 70) {
          setLightLevel('Medium Light');
          setDescription('This area gets good indirect light, perfect for many common houseplants.');
          setSuitablePlants(['Monstera', 'Rubber Plant', 'Philodendron', 'Peperomia']);
        } else {
          setLightLevel('Bright Light');
          setDescription('This spot receives plenty of light, ideal for sun-loving plants.');
          setSuitablePlants(['Cacti', 'Succulents', 'Fiddle Leaf Fig', 'Bird of Paradise']);
        }
      ...
      >
        ...
        >
          ...
          <View style={styles.meterContainer}>
            <View style={[
              styles.meterOuter,
              measuring && styles.measuringOuter
            ]}>
              <View style={[
                styles.meterInner,
          ...
          {!measuring && lightReading > 0 ? (
            <View style={styles.resultsContainer}>
              ...
              <TouchableOpacity
                style={[styles.measureAgainButton, { backgroundColor: 'rgba(255,255,255,0.2)' }]}
