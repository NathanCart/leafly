...
export default function IdentifyScreen() {
  ...
  const [selectedPlant, setSelectedPlant] = useState<PlantIdentificationResult | null>(null);
  ...
  const handlePlantSelect = (plant: PlantIdentificationResult) => {
    setSelectedPlant({
      ...plant,
  ...
  const confirmPlantSelection = async (nickname: string) => {
    ...
    try {
      await addPlant({
        ...
        image_url: selectedPlant.capturedImageUri!,
        location: selectedPlant.location, // Ensure location is passed
        health_status: 'Healthy',
        notes: selectedPlant.description,
        is_favorite: false,
      });
      ...
      <View style={[
        ...
        <View style={styles.permissionContainer}>
          ...
          <Text style={[
            ...
            We need camera access to help you identify plants. Your camera will only be used when you're actively taking a photo.
          </Text>
          <Button
      ...
      <View style={styles.container}>
        ...
        <View style={styles.previewOverlay}>
          ...
          <View style={styles.previewControls}>
            <TouchableOpacity onPress={resetIdentification} style={styles.previewButton}>
              <X color="white" />
            </TouchableOpacity>
            <Button 
