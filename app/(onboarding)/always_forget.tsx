...
export default function AlwaysForget() {
	useMixpanel('always_forget');

	// Fire a light haptic before navigating
	const handleSelect = async (key: string) => {
		await Haptics.selectionAsync();
		router.push('/plant_health'); // replace with your actual next route
	};

	const handleSkip = async () => {
		await Haptics.selectionAsync();
		router.push('/plant_health');
	};
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<Text style={styles.title}>
				"I often <Text style={{ color: COLORS.primary, fontWeight: 'black' }}>forget</Text>{' '}
				my plants watering and care schedules"
			</Text>
